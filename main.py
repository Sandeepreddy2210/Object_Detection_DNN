...
classes = ["background", "aeroplane", "bicycle", "bird", "boat",
           "person", "bus", "car", "cat", "chair", "goggle", "diningtable",
...
while True:
    ...
    blob = cv2.dnn.blobFromImage(cv2.resize(image, (500, 500)), 0.007, (500, 500), 130)
    net.setInput(blob)
    ...
    for i in range(detected_objects.shape[2]):
        ...
        if confidence > min_confidence:
            ...
            cv2.putText(image, prediction_text, (upper_left_x,
                    upper_left_y - 10 if upper_left_y > 30 else upper_left_y + 10),
